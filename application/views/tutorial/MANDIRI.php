                             ...
                             <div class="col-lg-6">
                                 ...
                                 <div class="tab-content">
                                     <div class="tab-pane fade active show" id="atm">
                                         ...
                                         2. Masukkan Nomor Virtual Account <b><?php echo $listdata->trx_metode; ?></b>, lalu tekan 'BENAR'<br>
                                     ...
                                     <div class="tab-pane fade" id="ibanking">
                                         ...
                                         2. Masukkan Nomor Virtual Account <b><?php echo $listdata->trx_metode; ?></b><br>
                                     ...
                                     <b>LANGKAH 1: MASUK KE AKUN ANDA</b><br>
                                         ...
                                         <b>LANGKAH 2: DETAIL PEMBAYARAN</b><br>
                                         1. Pilih 88908 XENDIT sebagai penyedia jasa<br>
                                         2. Masukkan Nomor Virtual Account <b><?php echo $listdata->trx_metode; ?><br>
                                         3. Tekan Lanjut<br>
