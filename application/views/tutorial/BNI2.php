        ...
        <div class="col-lg-6">
            ...
            <div class="tab-content">
                <div class="tab-pane fade active show" id="atmbersama">
                    ...
                    1. Masukkan rangkaian kode Bank BNI (009) disertakan dengan nomor Virtual Account yang tertera: <b><?php echo $listdata->code_metode; ?></b>, dan pilih "Benar" atau "Lanjut"(Sebagai contoh: 009 <b><?php echo $listdata->code_metode; ?></b>)<br>
                ...
                <div class="tab-pane fade" id="atmprima">
                    ...
                    2. Masukkan jumlah pembayaran dalam nominal Rupiah yang sesuai dengan yang tertera. Pastikan jumlah nominal yang Anda masukkan adalah nominal yang sesuai dengan angka tagihan tertera. Selanjutnya, pilih "Benar" atau "Lanjut"<br>
                    3. Masukkan rangkaian angka Virtual Account yang tertera: <b><?php echo $listdata->code_metode; ?></b>. Pastikan kembali bahwa angka Virtual Account yang Anda masukkan adalah sesuai dengan yang tertera. Selanjutnya pilih "Benar" atau "Lanjut"<br>
                ...
                <div class="tab-pane fade" id="ibanking">
                    ...
                    <b>LANGKAH 2: DETAIL PEMBAYARAN</b><br>
                    1. Masukkan rangkaian angka Virtual Account yang tertera: <b><?php echo $listdata->code_metode; ?></b>. Pastikan kembali bahwa angka Virtual Account yang Anda masukkan adalah sesuai dengan yang tertera. Selanjutnya pilih "Benar" atau "Lanjut". Pastikan layar menampilkan nama Virtual Account seperti yang tertera:  <b><?php echo $nama; ?></b>. Masukkan permintaan verifikasi dengan token bank apabila diperlukan<br>
                ...
                <b>LANGKAH 1: MASUK KE AKUN ANDA</b><br>
                    ...
                    2. Masukkan rangkaian angka Virtual Account yang tertera: <b><?php echo $listdata->code_metode; ?></b>. Pastikan kembali bahwa angka Virtual Account yang Anda masukkan adalah sesuai dengan yang tertera. Selanjutnya pilih "Benar" atau "Lanjut". Pastikan layar menampilkan nama Virtual Account seperti yang tertera:  <b><?php echo $nama; ?></b><br>
