                             ...
                             <div class="col-lg-6">
                                 ...
                                 <div class="tab-content">
                                     <div class="tab-pane fade active show" id="atm">
                                         ...
                                         1. Masukkan Nomor Virtual Account <b><?php echo $listdata->trx_metode; ?></b> dan jumlah yang ingin anda bayarkan<br>
                                     ...
                                     <div class="tab-pane fade" id="mbanking">
                                         ...
                                         2. Pilih "Pembayaran" dan pilih "Briva"<br>
                                         <b>LANGKAH 2: DETAIL PEMBAYARAN</b><br>
                                         1. Masukkan Nomor Virtual Account anda <b><?php echo $listdata->trx_metode; ?></b> dan jumlah yang ingin anda bayarkan<br>
