<div class="bt-1 p-20">
    <div class="row">
        <div class="col-lg-6">
        <img alt='Qrcode QRIS'
       src='https://barcode.tec-it.com/barcode.ashx?data=<?php echo urlencode($listdata->trx_metode); ?>&code=QRCode&multiplebarcodes=false&translate-esc=false&unit=Fit&dpi=96&imagetype=Gif&rotation=0&color=%23000000&bgcolor=%23ffffff&codepage=Default&qunit=Mm&quiet=0&eclevel=L'/>
            <hr class="my-3">
