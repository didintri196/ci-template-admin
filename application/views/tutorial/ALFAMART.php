<div class="bt-1 p-20">
    <div class="row">
        <div class="col-lg-6">
        <img alt='Barcode Alfamart' src='https://barcode.tec-it.com/barcode.ashx?data=<?php echo $listdata->code_metode; ?>&code=Code128&translate-esc=on'/>
            <hr class="my-3">
        ...
        <div class="col-lg-6">
            ...
            <div class="tab-content">
                ...
                <b>LANGKAH 1: TEMUKAN CABANG TERDEKAT</b><br>
                    ...
                    2. Sebutkan pembayaran melalui "<b>NEXTOID</b>" ke kasir, atau berikan kode barcode untuk di scan oleh kasir.<br>
