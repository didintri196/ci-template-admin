<div class="col-12">
    ...
    <div class="card" style="border-radius: 10px;">
        <div class="card-body">
            <h2>List Asrama <button class="btn btn-warning btn-round" data-toggle="modal" data-target="#modal-add">Add Asrama</button></h2>
            <hr class="my-2">
                    ...
                    <tbody>
                        ...
                        foreach ($listdata->result() as $row_data) { ?>
                            <tr>
                                ...
                                <td>
                                <a href="/account/asrama/<?php echo $row_data->id; ?>/fasilitas" class="btn btn-success btn-sm btn-round">List Fasilitas</a>
                                    <div class="btn-group ">
...
<div class="modal modal-center fade" id="modal-add" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="/account/asrama/add" method="POST">
...
<div class="modal modal-center fade" id="modal-edit" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="/account/asrama/update" method="POST">
                <div class="modal-header">
...
<div class="modal modal-center fade" id="modal-delete" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content" style="border-radius: 10px;">
            <form action="/account/asrama/delete" method="POST">
                <div class="modal-header">
...
<script>
    function getview(id) {
        $.getJSON("/account/asrama/view/" + id, function(data) {
            // console.log(data);
